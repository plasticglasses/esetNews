...
/**
 * display a map that community users can share news on
 */
class LocalFragment : Fragment() {
    ...
    private val callback = OnMapReadyCallback { googleMap ->
        ...
        //add amrkers that are in firebase markers collection to the map
        ...
        // move the camera to foucs on swansea
        mMap.setMinZoomPreference(15.0f)

        //when you click a marker, show description
